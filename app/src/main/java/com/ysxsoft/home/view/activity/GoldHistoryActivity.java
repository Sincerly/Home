...
import com.ysxsoft.home.response.GoldHistoryResponse;
 ...
 **/
@Route(path = "/main/GoldHistoryActivity")
public class GoldHistoryActivity extends BaseActivity
        implements IListAdapter<GoldHistoryResponse.DataBean> {
    ...
    public static void start() {
        ARouter.getInstance().build(ARouterPath.getGoldHistoryActivity()).navigation();
    }
    ...
    public int getItemLayoutId() {
        return R.layout.item_activity_gold_history_list;
    }

    @Override
    public void request(int page) {
        OkHttpUtils.post()
                .url(AppConfig.getInstance().GOLD_DETAIL)
                .addParams("uid", SharedPreferencesUtils.getUid(GoldHistoryActivity.this))
                .addParams("page", page + "")
                .tag(this)
                .build()
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        manager.releaseRefresh();
                        GoldHistoryResponse resp = JsonUtils.parseByGson(response, GoldHistoryResponse.class);
                        if (resp != null) {
                            if (HttpResponse.SUCCESS.equals(resp.getCode())) {
                                //请求成功
                                List<GoldHistoryResponse.DataBean> data = resp.getData();
    ...
    @Override
    public void fillView(BaseViewHolder helper, GoldHistoryResponse.DataBean s) {
        TextView money = helper.getView(R.id.money);
        money.setText(s.getNum());
        if("6".equals(s.getType())){
            //支出
    ...
    @Override
    public void fillMuteView(BaseViewHolder helper,GoldHistoryResponse.DataBean s) {
    }
